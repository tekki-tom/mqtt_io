...
int main()
{
    ...
    while (true)
    {
        ...
        //  if (2 != result)
        //      error();
        sendi2c(io_expander0, 0x15, 0x01);
        sendi2c(io_expander1, 0x15, 0x00);
        sendi2c(io_expander2, 0x15, 0x00);
        gpio_put(LED_PIN, 1);
        cyw43_arch_gpio_put(CYW43_WL_GPIO_LED_PIN, 0);
        sleep_ms(1000);
        sendi2c(io_expander0, 0x15, 0x00);
        sendi2c(io_expander1, 0x15, 0x01);
        sendi2c(io_expander2, 0x15, 0x00);
        gpio_put(LED_PIN, 0);
        cyw43_arch_gpio_put(CYW43_WL_GPIO_LED_PIN, 1);
        sleep_ms(1000);
        sendi2c(io_expander0, 0x15, 0x00);
        sendi2c(io_expander1, 0x15, 0x00);
        sendi2c(io_expander2, 0x15, 0x01);
        gpio_put(LED_PIN, 1);
        // cyw43_arch_gpio_put(CYW43_WL_GPIO_LED_PIN, 1);
        sleep_ms(1000);
    }    
